...
- ✅ Реализована работа с БД и локальным хранилищем для хранения и обновления настроек, статистики
- ✅ Добавлена *регистрация* пользователя при первом входе в приложение
...
- [x] DI контейнер
- [x] Репозитории (User, Settings)
- [x] Экран регистрации пользователя
